...
class Incidente(Base):
    ...
    condicion_meteorologica: Mapped[str | None] = mapped_column(String(100), nullable=True)
    condicion_luz: Mapped[str | None] = mapped_column(String(50), nullable=True)
    visibilidad_millas: Mapped[float | None] = mapped_column(Float, nullable=True)
